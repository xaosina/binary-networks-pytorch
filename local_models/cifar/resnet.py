...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=100, rprelu=False):
        self.inplanes = 64
        self.rprelu = rprelu
        super(ResNet, self).__init__()
        self.first_conv = nn.Conv2d(3, 64, kernel_size=3, stride=1, padding=1, bias=False) #don't quantize the first layer
