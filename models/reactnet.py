# Based on mobilenet architechture
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1):
        ...
        self.simple_3x3= conv3x3(inplanes, inplanes, stride=stride)
        ...
        if inplanes == planes:
            self.pw = conv1x1(inplanes, planes)
            self.bn2 = norm_layer(planes)
        else:
            self.pw_down1 = conv1x1(inplanes, inplanes)
            self.pw_down2 = conv1x1(inplanes, inplanes)
    ...
    def forward(self, x):
        ...
        if self.inplanes == self.planes:
            ...
            out2_1 = self.pw_down1(out2)
            out2_2 = self.pw_down2(out2)
